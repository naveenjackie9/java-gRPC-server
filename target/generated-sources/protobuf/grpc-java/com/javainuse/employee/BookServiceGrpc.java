...
public final class BookServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.javainuse.employee.BookPostRequest,
      com.javainuse.employee.BookResponse> getPostBookMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "postBook",
      requestType = com.javainuse.employee.BookPostRequest.class,
      responseType = com.javainuse.employee.BookResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.javainuse.employee.BookPostRequest,
      com.javainuse.employee.BookResponse> getPostBookMethod() {
    io.grpc.MethodDescriptor<com.javainuse.employee.BookPostRequest, com.javainuse.employee.BookResponse> getPostBookMethod;
    if ((getPostBookMethod = BookServiceGrpc.getPostBookMethod) == null) {
      synchronized (BookServiceGrpc.class) {
        if ((getPostBookMethod = BookServiceGrpc.getPostBookMethod) == null) {
          BookServiceGrpc.getPostBookMethod = getPostBookMethod = 
              io.grpc.MethodDescriptor.<com.javainuse.employee.BookPostRequest, com.javainuse.employee.BookResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BookService", "postBook"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.javainuse.employee.BookPostRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.javainuse.employee.BookResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new BookServiceMethodDescriptorSupplier("postBook"))
                  .build();
          }
        }
     }
     return getPostBookMethod;
  }
  ...
  public static abstract class BookServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void postBook(com.javainuse.employee.BookPostRequest request,
        io.grpc.stub.StreamObserver<com.javainuse.employee.BookResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getPostBookMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.javainuse.employee.BookPostRequest,
                com.javainuse.employee.BookResponse>(
                  this, METHODID_POST_BOOK)))
          .build();
    }
  }
  ...
  public static final class BookServiceStub extends io.grpc.stub.AbstractStub<BookServiceStub> {
    ...
    public void postBook(com.javainuse.employee.BookPostRequest request,
        io.grpc.stub.StreamObserver<com.javainuse.employee.BookResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getPostBookMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class BookServiceBlockingStub extends io.grpc.stub.AbstractStub<BookServiceBlockingStub> {
    ...
    /**
     */
    public com.javainuse.employee.BookResponse postBook(com.javainuse.employee.BookPostRequest request) {
      return blockingUnaryCall(
          getChannel(), getPostBookMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class BookServiceFutureStub extends io.grpc.stub.AbstractStub<BookServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.javainuse.employee.BookResponse> postBook(
        com.javainuse.employee.BookPostRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getPostBookMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_BOOK = 0;
  private static final int METHODID_POST_BOOK = 1;
      ...
      switch (methodId) {
        case METHODID_GET_BOOK:
          serviceImpl.getBook((com.javainuse.employee.BookRequest) request,
              (io.grpc.stub.StreamObserver<com.javainuse.employee.BookResponse>) responseObserver);
          break;
        case METHODID_POST_BOOK:
          serviceImpl.postBook((com.javainuse.employee.BookPostRequest) request,
              (io.grpc.stub.StreamObserver<com.javainuse.employee.BookResponse>) responseObserver);
          break;
        default:
